...
APP_KEY= 't3cyFSkiWB4bSbUCOfKFQfdmU'
...
OAUTH_TOKENSECRET= 'wJFbjSZSYT4raoMYMTsaA76WUTklEYgW7gQzMG4h6xNFs'


class TwitterCrawler:
    def __init__(self):
        # INSTANCIA DE TWYTHON PARA HACER PETICIONES A LA API
        self.t = Twython(app_key= APP_KEY, app_secret= APP_SECRET, oauth_token= OAUTH_TOKEN, oauth_token_secret= OAUTH_TOKENSECRET)
        self.trends = list()
